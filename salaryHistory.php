...
<?php 
	if (isset($_REQUEST['notyId'])) {
		$notyId = $_REQUEST['notyId'];

		$up_noty = $pdo->prepare('UPDATE notification SET status=? WHERE id=?');
		$up_noty->execute(array('read',$notyId));
...
<div class="row">
    <div class="col-xl-12">
        <div class="breadcrumb-holder">
            <h1 class="main-title float-left">Your Salary History</h1>
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
        <div class="card mb-3">
            <div class="card-header">
                <h3><i class="fas fa-table"></i> Your Salary History</h3>
               	If you find any data of your please search here any data.
            </div>
                    	...
                    	<div class="row">
                    		<div class="col-sm-12">
                    			<table id="dataTable" class="table table-bordered table-hover display dataTable no-footer" style="width: 100%;" role="grid" aria-describedby="dataTable_info">
                    				...
                    				<tbody>
				                    	<?php 
					                        $salaryH = $pdo->prepare('SELECT * FROM empsalary WHERE emp_id=? ORDER BY send_date DESC');
					                        $salaryH->execute(array($_SESSION['logged_emp']));
