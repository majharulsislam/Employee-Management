            ...
            <div class="card-box noradius noborder bg-purple">
                ...
                <h6 class="text-white text-uppercase m-b-20">Salaries</h6>
                    <?php
                        ...
                        $stm = $pdo->prepare('SELECT * FROM empsalary WHERE currentdate=?');
                ...
                <span class="text-white">All Employee Total Month Salary</span>
            </div>
        </div>
            ...
            <div class="card-box noradius noborder bg-warning">
                ...
                <h6 class="text-white text-uppercase m-b-20">Projects</h6>
                    <?php
                        ...
                        $stm = $pdo->prepare('SELECT * FROM projects WHERE monthly_project_date=? AND completed=?');
                        $stm->execute(array($current_month,0));
            ...
            <div class="card-box noradius noborder bg-info">
                ...
                <h6 class="text-white text-uppercase m-b-20">Earns</h6>
                    <?php
                        ...
                        $statement = $pdo->prepare('SELECT * FROM projects WHERE monthly_project_date=?');
                    ...
                    <?php
                        $earnmonth = date('Y-m');
                        $stm = $pdo->prepare('SELECT * FROM earning WHERE currentdate=?');
                        $stm->execute(array($earnmonth));
                ...
                <span class="text-white">Current Month Earning</span>
            </div>
        </div>
        ...
        <div class="col-xs-12 col-md-4">
            <div class="card-box noradius noborder bg-primary">
                ...
                <h6 class="text-white text-uppercase m-b-20">Spent</h6>
                    ...
                    <?php
                        $spendmonth = date('Y-m');
                        $stm = $pdo->prepare('SELECT * FROM spending WHERE spend_month=?');
                        $stm->execute(array($spendmonth));
