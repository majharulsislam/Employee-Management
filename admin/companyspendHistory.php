...
<div class="row">
    <div class="col-xl-12">
        <div class="breadcrumb-holder">
            <h1 class="main-title float-left">Spend History</h1>
            <ol class="breadcrumb float-right">
                <li class="breadcrumb-item">Company Spend</li>
                <li class="breadcrumb-item active">Spend History</li>
            </ol>
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
        <div class="card mb-3">
            <div class="card-header">
                <h3><i class="fas fa-table"></i> Company Spend History</h3>
               	If you find any spend source please search here any data.
            </div>
                    	...
                    	<div class="row">
                    		<div class="col-sm-12">
                    			<table id="dataTable" class="table table-bordered table-hover display dataTable no-footer" style="width: 100%;" role="grid" aria-describedby="dataTable_info">
                    				...
                    				<tbody>
				                    <?php 
				                        $stm = $pdo->prepare('SELECT * FROM spending ORDER BY spend_date DESC');
				                        $stm->execute();
				                    ...
				                    ?>
					                    <tr>
					                      ...
					                      <td><?php echo $row['spend_source']; ?></td>
					                      <td>$<?php echo $row['spend_amount']; ?></td>
					                      <td>
					                        <?php 
					                            $spend_date = $row['spend_date'];

					                            $day = substr($spend_date,8,2);
					                            $month = substr($spend_date,5,2);
					                            $year = substr($spend_date,0,4);
