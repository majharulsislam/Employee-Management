            ...
            <div class="col-md-4">
                <div class="form-group">
                    <select name="emp_id" class="form-control">
                        <?php 
                            $view = $pdo->prepare('SELECT id,emp_fullname FROM employee_info WHERE id=?');
                            $view->execute(array($_SESSION['logged_emp']));
        ...
        <div class="table-responsive">
           <table class="table table-bordered bg-light">
              ...
              <tbody>
                ...
                <?php 
                    $viewdata = $pdo->prepare('SELECT * FROM employee_info WHERE id=?');
                    $viewdata->execute(array($_SESSION['logged_emp']));
